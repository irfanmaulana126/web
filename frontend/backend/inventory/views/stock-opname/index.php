...
$this->title='Stok Opname';
	...
	$aryFieldColomn[]=['ID' =>0, 'ATTR' =>['FIELD'=>'storeNm','SIZE' => '10px','WIDTH'=>'50px','label'=>'TOKO1','align'=>'left','group'=>true,'pageSummary'=>false]];
	// $aryFieldColomn[]=['ID' =>1, 'ATTR' =>['FIELD'=>'STORE_NM','SIZE' => '9px','WIDTH'=>'50px','label'=>'TOKO','align'=>'left','group'=>false,'pageSummary'=>false]];
	$aryFieldColomn[]=['ID' =>1, 'ATTR' =>['FIELD'=>'produkNm','SIZE' => '9px','WIDTH'=>'50px','label'=>'PRODUK','align'=>'left','group'=>false,'pageSummary'=>false]];
	...
	//---STOK AKUMULASI
	$aryFieldColomn[]=['ID' =>2, 'ATTR' =>['FIELD'=>'STOCK_AWAL','SIZE' => '9px','WIDTH'=>'50px','label'=>'LALU','align'=>'right','group'=>false,'pageSummary'=>false]];
	$aryFieldColomn[]=['ID' =>3, 'ATTR' =>['FIELD'=>'STOCK_BARU','SIZE' => '9px','WIDTH'=>'50px','label'=>'MASUK','align'=>'right','group'=>false,'pageSummary'=>false]];
	$aryFieldColomn[]=['ID' =>4, 'ATTR' =>['FIELD'=>'STOCK_TERJUAL','SIZE' => '9px','WIDTH'=>'50px','label'=>'TERJUAL','align'=>'right','group'=>false,'pageSummary'=>false]];
	$aryFieldColomn[]=['ID' =>5, 'ATTR' =>['FIELD'=>'STOCK_REFUND','SIZE' => '9px','WIDTH'=>'50px','label'=>'REFUND','align'=>'right','group'=>false,'pageSummary'=>false]];
	$aryFieldColomn[]=['ID' =>6, 'ATTR' =>['FIELD'=>'STOCK_AKHIR','SIZE' => '9px','WIDTH'=>'50px','label'=>'SISA','align'=>'right','group'=>false,'pageSummary'=>false]];
	$aryFieldColomn[]=['ID' =>7, 'ATTR' =>['FIELD'=>'STOCK_BALANCE_CLOSING','SIZE' => '9px','WIDTH'=>'50px','label'=>'BALANCE','align'=>'right','group'=>false,'pageSummary'=>false]];
	$headerContent1[]=['content'=>'TOTAL STOK','options'=>['colspan'=>5,'WIDTH'=>'50px','class'=>'text-center','style'=>'background-color:'.$colorHeader1.';font-family: tahoma ;font-size: 6pt;']];
	//---OPNAME AKUMULASI
	$headerContent1[]=['content'=>'STOK OPNAME BULANAN','options'=>['colspan'=>3,'WIDTH'=>'50px','class'=>'text-center','style'=>'background-color:'.$colorHeader1.';font-family: tahoma ;font-size: 6pt;']];
	$aryFieldColomn[]=['ID' =>8, 'ATTR' =>['FIELD'=>'STOK_CLOSING','SIZE' => '9px','WIDTH'=>'50px','label'=>'CLOSING','align'=>'right','group'=>false,'pageSummary'=>false]]; 
	$aryFieldColomn[]=['ID' =>9, 'ATTR' =>['FIELD'=>'STOCK_INPUT_ACTUAL','SIZE' => '9px','label'=>'STOK ACTUAL','align'=>'right','group'=>false,'pageSummary'=>false,'BCOLOR'=>$colorHeader]];
	$aryFieldColomn[]=['ID' =>10, 'ATTR' =>['FIELD'=>'STOCK_BALANCE_BULAN','SIZE' => '9px','label'=>'BALANCE','align'=>'right','group'=>false,'pageSummary'=>false,'BCOLOR'=>$colorHeader]];	//---TROK AKHIR AKUMULASI
	$headerContent1[]=['content'=>'OPNAME STOK AKHIR','options'=>['colspan'=>1,'class'=>'text-center','style'=>'background-color:'.$colorHeader1.';font-family: tahoma ;font-size: 6pt;']];		
	$aryFieldColomn[]=['ID' =>11, 'ATTR' =>['FIELD'=>'STOCK_AKHIR_ACTUAL','SIZE' => '9px','label'=>'STOK AKHIR','align'=>'right','group'=>false,'pageSummary'=>false,'BCOLOR'=>$colorHeader]];
