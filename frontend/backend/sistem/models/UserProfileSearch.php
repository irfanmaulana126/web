...
/**
 * UserProfileSearch represents the model behind the search form of `frontend\backend\sistem\models\UserProfile`.
 */
class UserProfileSearch extends UserProfile
{
	...
	{	
		return $this->NM_DEPAN.' '.$this->NM_TENGAH.' '.$this->NM_BELAKANG;
	}
