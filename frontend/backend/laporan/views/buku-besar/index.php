...
<div class="container-fluid" style="font-family: verdana, arial, sans-serif ;font-size: 8pt">
	<div class="col-xs-12 col-sm-12 col-lg-12" style="font-family: tahoma ;font-size: 8pt;">
		...
		$icon1 = '<span class="fa-stack fa-md text-left">
			...
			<div style="height:20px;text-align:center;font-family: tahoma ;font-size: 10pt;;padding-top:10px;margin-left:20px;">	
                    <?php		                    
					...
					'columns' => [
							[	
								...
								{     								   
									...
									return Yii::$app->controller->renderPartial('/buku-besar/index_detail',[
