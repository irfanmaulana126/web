...
$this->registerCss("
	...
	*/
	...
	#ppob-export-excel-modal .modal-header {
		background: linear-gradient( 135deg, #2AFADF 10%, #4C83FF 100%);
	}
	#ppob-store-modal .modal-header {
		background: linear-gradient( 135deg, #2AFADF 10%, #4C83FF 100%);
	}
");
...
*/
	...
	Modal::begin([
		...
		echo "<div id='ppob-export-excel-content'></div>";
	Modal::end();
	...
	Modal::begin([
		...
		echo "<div id='ppob-store-content'></div>";
	Modal::end();
