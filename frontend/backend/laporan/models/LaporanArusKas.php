...
{	
    ...
    {
        return [
            [['KREDIT','KREDIT','TAHUN','ACCESS_GROUP','STORE_ID','BULAN','AKUN_CODE'], 'safe'],
        ];
    }
	public function searchArusKeuangan($params){
		$sql="				
			...
			SELECT  
				...
				'".$this->BULAN."' AS BULAN,'".$this->TAHUN."' AS TAHUN,
	...
	public function searchArusDetail($params){
	  ...
	  $akunkode=$this->AKUN_CODE!=''?$this->AKUN_CODE:'';
	  ...
	  switch ($akunkode) {
		case '1-1001':				
			$datas=['concat'=>"CONCAT(
				...
				'field'=>"rslt1.PRODUK_SUBTTL_HARGAJUAL,rslt1.PRODUK_SUBTTL_QTY",
				'cs'=>"(CASE WHEN x2.PRODUK_SUBTTL_HARGAJUAL IS NOT NULL THEN x2.PRODUK_SUBTTL_HARGAJUAL ELSE 0 END) AS PRODUK_SUBTTL_HARGAJUAL,
						(CASE WHEN x2.PRODUK_SUBTTL_QTY IS NOT NULL THEN x2.PRODUK_SUBTTL_QTY ELSE 0 END) AS PRODUK_SUBTTL_QTY",
				'field2'=>"sum(PRODUK_SUBTTL_HARGAJUAL) as PRODUK_SUBTTL_HARGAJUAL,sum(PRODUK_SUBTTL_QTY) as PRODUK_SUBTTL_QTY"
			];
			break;
		case '1-1002':
			$datas=['concat'=>"CONCAT(
		...
		case '3-1002':
			$datas=['concat'=>"CONCAT(
				...
				'field'=>"rslt1.PRODUK_JUALPPNDISCOUNT,rslt1.PRODUK_SUBTTL_QTY",
				'cs'=>"(CASE WHEN x2.PRODUK_JUALPPNDISCOUNT IS NOT NULL THEN x2.PRODUK_JUALPPNDISCOUNT ELSE 0 END) AS PRODUK_JUALPPNDISCOUNT,
					   (CASE WHEN x2.PRODUK_SUBTTL_QTY IS NOT NULL THEN x2.PRODUK_SUBTTL_QTY ELSE 0 END) AS PRODUK_SUBTTL_QTY",
				'field2'=>"sum(PRODUK_JUALPPNDISCOUNT) as PRODUK_JUALPPNDISCOUNT,sum(PRODUK_SUBTTL_QTY) as PRODUK_SUBTTL_QTY"
			];	
			break;	
		case '3-1003':
			$datas=['concat'=>" CONCAT(
				...
				'field'=>"rslt1.PRODUK_SUBTTL_PPN,rslt1.PRODUK_SUBTTL_QTY",
				'cs'=>"(CASE WHEN x2.PRODUK_SUBTTL_PPN IS NOT NULL THEN x2.PRODUK_SUBTTL_PPN ELSE 0 END) AS PRODUK_SUBTTL_PPN,
						(CASE WHEN x2.PRODUK_SUBTTL_QTY IS NOT NULL THEN x2.PRODUK_SUBTTL_QTY ELSE 0 END) AS PRODUK_SUBTTL_QTY",
				'field2'=>"sum(PRODUK_SUBTTL_PPN) as PRODUK_SUBTTL_PPN,sum(PRODUK_SUBTTL_QTY) as PRODUK_SUBTTL_QTY"
			];	
			break;
		case '3-2001':
			$datas=['concat'=>"CONCAT(
		...
		case '4-1001':
			$datas=['concat'=>" CONCAT(
				...
				'field'=>"rslt1.REFUND_SUBTTL_HARGAJUAL,rslt1.REFUND_SUBTTL_QTY",
				'cs'=>" (CASE WHEN x2.REFUND_SUBTTL_HARGAJUAL IS NOT NULL THEN x2.REFUND_SUBTTL_HARGAJUAL ELSE 0 END) AS REFUND_SUBTTL_HARGAJUAL,
						(CASE WHEN x2.REFUND_SUBTTL_QTY IS NOT NULL THEN x2.REFUND_SUBTTL_QTY ELSE 0 END) AS REFUND_SUBTTL_QTY",
				'field2'=>"sum(REFUND_SUBTTL_HARGAJUAL) as REFUND_SUBTTL_HARGAJUAL,sum(REFUND_SUBTTL_QTY) as REFUND_SUBTTL_QTY"
			];
			break;
		case '5-1001':
			$datas=['concat'=>"CONCAT(
	...
	//   print_r($qrySqlField);die();
	  $qrySql= Yii::$app->production_api->createCommand("
		  SELECT 
			  rslt1.ACCESS_GROUP,rslt1.STORE_ID,st.STORE_NM,rslt1.PRODUCT_ID,rslt1.PRODUCT_NM,rslt1.TGL,".$datas['field'].",".$rsltField." 
		  FROM
		  (
			  SELECT 
				  ...
				  (CASE WHEN x1.PRODUCT_ID IS NOT NULL THEN x1.PRODUCT_ID ELSE x2.PRODUCT_ID END) AS PRODUCT_ID,".$datas['cs'].",
			...
			FROM
			  ...
			  LEFT OUTER JOIN
			  (
			  SELECT ACCESS_GROUP,STORE_ID,PRODUCT_ID,TGL,".$datas['field2']."
			  FROM ptr_kasir_td1a 
