...
/**
 * This is the model class for table "ptr_kasir_td1c".
 *
 ...
 */
class PtrKasirTd1c extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['TRANS_MONTH', 'MONTH_AT', 'YEAR_AT'], 'required'],
            ...
            [['TRANS_MONTH', 'PRODUCT_NM'], 'string', 'max' => 100],
            [['ACCESS_GROUP'], 'string', 'max' => 15],
            [['STORE_ID'], 'string', 'max' => 20],
            [['TAHUN'], 'string', 'max' => 5],
            [['PRODUCT_ID', 'UNIT_NM'], 'string', 'max' => 50],
            [['PRODUCT_PROVIDER', 'PRODUCT_PROVIDER_NO', 'PRODUCT_PROVIDER_NM'], 'string', 'max' => 255],
            [['TRANS_MONTH', 'MONTH_AT', 'YEAR_AT'], 'unique', 'targetAttribute' => ['TRANS_MONTH', 'MONTH_AT', 'YEAR_AT']],
        ];
    }
