...
/**
 * This is the model class for table "ptr_kasir_td1a".
 *
 ...
 * @property int $TRANS_TYPE 0=produk toko; 1=refund; 2=ppob; 3=lain2
 ...
 */
class PtrKasirTd1a extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['TRANS_DAY', 'BULAN', 'MONTH_AT', 'YEAR_AT'], 'required'],
            ...
            [['TRANS_DAY', 'PRODUCT_NM'], 'string', 'max' => 100],
