...
use frontend\backend\laporan\models\PtrKasirTd1b;

/**
 * PtrKasirTd1bSearch represents the model behind the search form of `frontend\backend\laporan\models\PtrKasirTd1b`.
 */
class PtrKasirTd1bSearch extends PtrKasirTd1b
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['TRANS_WEEK', 'ACCESS_GROUP', 'STORE_ID', 'TRANS_DATE', 'TAHUN', 'PRODUCT_ID', 'PRODUCT_NM', 'PRODUCT_PROVIDER', 'PRODUCT_PROVIDER_NO', 'PRODUCT_PROVIDER_NM', 'UNIT_NM', 'CREATE_AT', 'UPDATE_AT'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'TRANS_WEEK', $this->TRANS_WEEK])
