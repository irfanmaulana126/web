...
/* @var $model app\backend\master\models\ItemFdiscountSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="item-fdiscount-search">
    ...
    <?php // echo $form->field($model, 'PERIODE_TIME1') ?>

    <?php // echo $form->field($model, 'PERIODE_TIME2') ?>
