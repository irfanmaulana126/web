...
?>
 ...
 <?php $form = ActiveForm::begin([
	...
	'validationUrl'=>Url::toRoute('/master/item/valid-item'),
	]); ?>
<div style="height:100%;font-family: verdana, arial, sans-serif ;font-size: 8pt">
	<div class="row" >
		<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">	
			<?php // $form->field($model, 'OUTLET_CODE')->textInput(['value'=>$store_id,'maxlength' => true]) ?>
					...
					'pluginOptions' => [
						...
						'ajax' => [
							...
							'data' => new JsExpression('function(params) { 
									return {q:params.term,outlet_code:"'.$store_id.'"}; 
								}
							')
						],
					],
