...
class PenggajianRekapSearch extends DynamicModel
{
    ...
    {
        return [
           [['ACCESS_GROUP','STORE_ID','STORE_NM','KARYAWAN','UPAH_HARIAN'], 'safe'],
	...
	public function search($params){
		...
		// $TGL=$this->thn!=''?$this->thn:date('Y-m-d');
		 ...
		 $sqlStr="
			SELECT
				x1.ACCESS_GROUP,x1.STORE_ID,x2.STORE_NM,x1.KARYAWAN_ID,x1.KARYAWAN,x1.TGL,x1.UPAH_HARIAN,
			...
			(
				SELECT 
					ACCESS_GROUP,STORE_ID,KARYAWAN_ID,KARYAWAN,TGL,UPAH_HARIAN,
