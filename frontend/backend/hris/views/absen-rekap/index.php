...
$this->registerJs($this->render('absenrekap_script.js'),View::POS_READY);
echo $this->render('absenrekap_button'); //echo difinition
echo $this->render('absenrekap_modal'); //echo difinition
echo $this->render('absenrekap_column'); //echo difinition
...
$gvAbsenRekap=GridView::widget([
	...
	'beforeHeader'=>[
		[
			'columns'=>[
				['content'=>'JADWAL JAM KERJA', 'options'=>[
						'colspan'=>7,
						'style'=>[
							'width'=>'10px',
							'text-align'=>'center',
				...
				['content'=>'PERHITUNGAN ABSENSI', 'options'=>[
						'colspan'=>4,
						'style'=>[
							'width'=>'10px',
							'text-align'=>'center',
