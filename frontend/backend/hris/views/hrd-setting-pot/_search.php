...
/* @var $model frontend\backend\hris\models\HrdSettingPotSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="hrd-setting-pot-search">
    ...
    <?= $form->field($model, 'STT_POTONGAN') ?>

    <?php // echo $form->field($model, 'POT_PERSEN') ?>
