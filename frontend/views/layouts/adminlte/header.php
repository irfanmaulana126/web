            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs"><?=Yii::$app->getUserOpt->user()['PROFILE_NM']?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            ...
                            <p>
                                <?=Yii::$app->getUserOpt->user()['PROFILE_NM']?>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="/sistem/user-profile" class="btn btn-default btn-flat">Profile</a>
                            </div>
